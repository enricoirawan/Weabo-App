    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `AnimeEntity` (`id` INTEGER NOT NULL, `imageUrl` TEXT NOT NULL, `title` TEXT NOT NULL, `score` REAL NOT NULL, `status` TEXT NOT NULL, `synopsis` TEXT NOT NULL, PRIMARY KEY (`id`))');
